...
clc;clear;close all
tic;
CostFunction=@ Objective_function;     % Cost Function
nVar=15;             % Number of Decision Variables

VarSize=[1 nVar];   % Decision Variables Matrix Size
%VarMin = [68000 40.85  0.35 21.37 8.5];  % For HS , N=5, 1D problem. 
% VarMax = [92000 45.15  0.7 23.62 11.5];
VarMin = [21.375 25000 0.234 40.85   22.51 54322 0.212 44.65 21.375 38318 0.227 42.75];  % For HS , N=5, 3D problem. 
VarMax = [23.625 35000 0.3465 45.15  24.885 73495 0.3456 49.35 23.625 51843 0.253  47.25];
...
for it=1:MaxIt
    ...
    for k=1:nc/2
        ...
        i1=RouletteWheelSelection(P); %heuristic or single point 
    ...
    for k=1:nm
        ...
        % Apply Mutation
        popm(k).Position=Mutation(p.Position,mu,VarMin,VarMax);
        
        % Evaluate Mutant
        popm(k).Cost=Objective_function(popm(k).Position);
